...
import in.afckstechnologies.mail.afckstrainer.Adapter.ContactForSmsListAdpter;
import in.afckstechnologies.mail.afckstrainer.Models.ContactListDAO;
import in.afckstechnologies.mail.afckstrainer.R;

public class DisplayCurrentContactsActivity extends AppCompatActivity {
    List<ContactListDAO> contactListDAOArrayList = new ArrayList<ContactListDAO>();
    SharedPreferences preferences;
    SharedPreferences.Editor prefEditor;
    ProgressDialog mProgressDialog;
    ContactListDAO contactListDAO;
    ContactForSmsListAdpter contactListAdpter;
    private RecyclerView mcontactList;
    String dName = "";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_display_current_contacts);
...
// add elements to al, including duplicates
    ...
    private class getContactList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(DisplayCurrentContactsActivity.this);
        ...
        protected void onPostExecute(Void args) {
            if (contactListDAOArrayList.size() > 0) {
                contactListAdpter = new ContactForSmsListAdpter(DisplayCurrentContactsActivity.this, contactListDAOArrayList);
                mcontactList.setAdapter(contactListAdpter);
                mcontactList.setLayoutManager(new LinearLayoutManager(DisplayCurrentContactsActivity.this));
