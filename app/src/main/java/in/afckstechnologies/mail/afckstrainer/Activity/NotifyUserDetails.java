...
/**
 * Created by Ashok Kumawat on 12/19/2017.
 */

public class NotifyUserDetails extends Activity {
    ...
    String courseListResponse = "", studentcommentListResponse = "", message = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            mobile_no = phone_no.substring(3, 13);
            //   Toast.makeText(context, "Incoming Call Ringing"+savedNumber , Toast.LENGTH_SHORT).show();
...
//                    this.setFinishOnTouchOutside(false);
    ...
    private class getStudentCommentDetailsList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(NotifyUserDetails.this);
    ...
    private class getLocationList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            if (centerResponse.compareTo("") != 0) {
                ...
                centerListAdpter = new StCenterListAdpter(NotifyUserDetails.this, data);
                mleadList.setAdapter(centerListAdpter);
                mleadList.setLayoutManager(new LinearLayoutManager(NotifyUserDetails.this));
    ...
    private class getCoursesList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            if (courseListResponse.compareTo("") != 0) {
                ...
                coursesListAdpter = new StCoursesListAdpter(NotifyUserDetails.this, cdata);
                cmleadList.setAdapter(coursesListAdpter);
                cmleadList.setLayoutManager(new LinearLayoutManager(NotifyUserDetails.this));
    ...
    private void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            private void init() {
                ...
                xMark = ContextCompat.getDrawable(NotifyUserDetails.this, R.drawable.ic_delete_black_24dp);
                xMark.setColorFilter(Color.BLACK, PorterDuff.Mode.SRC_ATOP);
                xMarkMargin = (int) NotifyUserDetails.this.getResources().getDimension(R.dimen.ic_clear_margin);
                initiated = true;
            }
