...
public class StudentEditPreActivity extends AppCompatActivity {
    ...
    String student_name="";
    TextView user_name;
    ImageView calling,commentButton;
    TextView commentEdtTxt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_student_edit_pre);
        ...
        if(!preferences.getString("st_notes","").equals("null")) {
            commentEdtTxt.setText(preferences.getString("st_notes", ""));
        }
        user_name.setText(preferences.getString("student_name",""));
        ...
        takeEditUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id","").equals("")) {
                    Intent intent = new Intent(StudentEditPreActivity.this, Activity_User_Profile.class);
        ...
        takeDeleteUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id","").equals("")) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(StudentEditPreActivity.this);
        ...
        takeChangeLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id","").equals("")) {
                    Intent intent = new Intent(StudentEditPreActivity.this, Activity_Location_Details.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(getApplicationContext(), "Please select student from list", Toast.LENGTH_LONG).show();
                }
        ...
        takeChangeCourses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id","").equals("")) {
                    Intent intent = new Intent(StudentEditPreActivity.this, TabsFragmentActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(getApplicationContext(), "Please select student from list", Toast.LENGTH_LONG).show();
                }
        ...
        takeChangedayprefrence.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id","").equals("")) {
                    Intent intent = new Intent(StudentEditPreActivity.this, Activity_DayPrefrence_Display.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(getApplicationContext(), "Please select student from list", Toast.LENGTH_LONG).show();
                }
       ...
       /* add_student.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                prefEditor.putString("student_name", newText);
                preferences.edit().remove("mobili_no").commit();
                preferences.edit().remove("emil_id").commit();
                preferences.edit().remove("student_last_name").commit();

                // prefEditor.putString("emil_id", newText);
                //prefEditor.putString("student_last_name", newText);
                //prefEditor.putString("mobili_no", newText);
                prefEditor.putString("book_seat", "student_pre");
                prefEditor.commit();
                RegistrationView registrationView = new RegistrationView();
                registrationView.show(getSupportFragmentManager(), "registrationView");
        ...
        takeTemplate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!preferences.getString("user_id","").equals("")) {
                    Intent intent = new Intent(StudentEditPreActivity.this, TemplateDisplayActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(getApplicationContext(), "Please select student from list", Toast.LENGTH_LONG).show();
                }
        ...
        calling.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i("call ph no", "" + preferences.getString("student_moblile_no",""));
                callIntent.setData(Uri.parse("tel:" + preferences.getString("student_moblile_no","")));
    ...
    private class initBatchSpinner extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(StudentEditPreActivity.this);
        ...
        protected void onPostExecute(Void args) {
            if (coursesResponse.compareTo("") != 0) {
                ...
                ArrayAdapter<BatchesDAO> adapter = new ArrayAdapter<BatchesDAO>(StudentEditPreActivity.this, android.R.layout.simple_spinner_dropdown_item, batcheslist) {
...
// add elements to al, including duplicates
    ...
    private class getContactList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            if (contactListDAOArrayList.size() > 0) {
                contactListAdpter = new ContactListAdpter(StudentEditPreActivity.this, contactListDAOArrayList);
                mcontactList.setAdapter(contactListAdpter);
                mcontactList.setLayoutManager(new LinearLayoutManager(StudentEditPreActivity.this));
    ...
    private class getLocationList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            if (centerResponse.compareTo("") != 0) {
                ...
                centerListAdpter = new StCenterListAdpter(StudentEditPreActivity.this, data);
                mleadList.setAdapter(centerListAdpter);
                mleadList.setLayoutManager(new LinearLayoutManager(StudentEditPreActivity.this));
    ...
    private class getCoursesList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            if (courseListResponse.compareTo("") != 0) {
                ...
                coursesListAdpter = new StCoursesListAdpter(StudentEditPreActivity.this, cdata);
                cmleadList.setAdapter(coursesListAdpter);
                cmleadList.setLayoutManager(new LinearLayoutManager(StudentEditPreActivity.this));
    ...
    private void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            private void init() {
                ...
                xMark = ContextCompat.getDrawable(StudentEditPreActivity.this, R.drawable.ic_delete_black_24dp);
                xMark.setColorFilter(Color.BLACK, PorterDuff.Mode.SRC_ATOP);
                xMarkMargin = (int) StudentEditPreActivity.this.getResources().getDimension(R.dimen.ic_clear_margin);
                initiated = true;
            }
